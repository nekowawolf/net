    ...
    <div className="bg-blue-600/20 border-divider-b relative flex rounded-t-2xl rounded-b-3xl min-h-[140px] overflow-hidden">
      ...
      <div className="pl-[135px] py-5 pr-5 flex flex-col justify-center">
        ...
        <p className="text-[11px] text-fill-color/70 leading-5 relative z-20">
          Your Nww Ecosystem AI assistant. Helping you discover useful websites, find the best resources, and provide in-depth explanations. 
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="p-5">
      ...
      <div className="flex flex-col gap-2.5">
        <button onClick={() => onSend("Find useful websites for me")} className="relative text-left px-4 py-3 rounded-xl border border-blue-600 bg-gradient-to-r from-blue-600/10 to-blue-500/10 hover:from-blue-600/20 hover:to-blue-500/20 transition-all text-sm text-fill-color/90 hover:text-fill-color shadow-sm cursor-pointer group">
            <span className="relative z-10">Find useful websites for me</span>
          </button>
          <button onClick={() => onSend("Recommend design resources")} className="relative text-left px-4 py-3 rounded-xl border border-blue-600 bg-gradient-to-r from-blue-600/10 to-blue-500/10 hover:from-blue-600/20 hover:to-blue-500/20 transition-all text-sm text-fill-color/90 hover:text-fill-color shadow-sm cursor-pointer group">
            <span className="relative z-10">Recommend design resources</span>
          </button>
          <button onClick={() => onSend("Help me find learning resources")} className="relative text-left px-4 py-3 rounded-xl border border-blue-600 bg-gradient-to-r from-blue-600/10 to-blue-500/10 hover:from-blue-600/20 hover:to-blue-500/20 transition-all text-sm text-fill-color/90 hover:text-fill-color shadow-sm cursor-pointer group">
            <span className="relative z-10">Help me find learning resources</span>
          </button>
      </div>
    </div>
  );
